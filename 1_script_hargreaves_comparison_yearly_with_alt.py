...
datumy=pd.date_range('1980-01-01', '2020-12-31', freq='D')
datumy_M=pd.date_range('1980-01-01', '2020-12-31', freq='M')
...
datum_merra=pd.date_range('1980-01-01', '2020-12-31', freq='D')
...
for stat in stations:
    ...
    stanica=str(stat)
    data= data_input.loc[(data_input['IndKl'] ==stanica)]
    data=data.loc['1980-01-01':'2020-12-31']
    ...
    et0_modif_droog=0.408*0.0029*(((tmax1+tmin1)/2)+21.27)*((tmax1-tmin1)**0.39)*(extraterrad)*(0.00014 *nad_vyska_st+0.97) 
    ...
    datasets.columns=['et0','et0_harg_orig','et0_harg_Rs','et0_liv', 'et0_modif','et0_modif_droog','et0_Berti','et0_droogersAllen2','et0_traj_balk','et0_Ravazzani']
    datasets.to_csv('C://Users//Viera//Desktop//projekty-clanky//clanok hargreaves//vysledky_stanice_yearly//et0_rozne_metody'+str(stat)+'.csv')
    datasets.index=datum_i
    datasets=datasets.dropna()
    datumy=datasets.index

    
    et0=datasets['et0']
    et0_short=datasets['et0_harg_orig']
    et0_har_Rs=datasets['et0_harg_Rs']
    et0_liv=datasets['et0_liv']
    et0_modif=datasets['et0_modif']
    et0_droogersAllen1=datasets['et0_Berti']
    et0_droogersAllen2=datasets['et0_droogersAllen2']
    et0_traj_balk=datasets['et0_traj_balk']
    et0_traj_pol=datasets['et0_Ravazzani']
    et0_modif_droog=datasets['et0_modif_droog']
    
    
    et0=pd.DataFrame(et0)
    et0_short=pd.DataFrame(et0_short)
    et0_har_Rs=pd.DataFrame(et0_har_Rs)
    et0_liv=pd.DataFrame(et0_liv)
    et0_modif=pd.DataFrame(et0_modif)
    et0_droogersAllen1=pd.DataFrame(et0_droogersAllen1)
    et0_droogersAllen2=pd.DataFrame(et0_droogersAllen2)
    et0_traj_balk=pd.DataFrame(et0_traj_balk)
    et0_traj_pol=pd.DataFrame(et0_traj_pol)
    et0_modif_droog=pd.DataFrame(et0_modif_droog)
    
    et0.index=datumy
    et0_short.index=datumy
    et0_har_Rs.index=datumy
    et0_liv.index=datumy
    et0_modif.index=datumy
    et0_droogersAllen1.index=datumy
    et0_droogersAllen2.index=datumy
    et0_traj_balk.index=datumy
    et0_traj_pol.index=datumy
    et0_modif_droog.index=datumy
    

    
    
    et0=et0.groupby(pd.PeriodIndex(et0.index, freq="Y")).sum()
    et0_short=et0_short.groupby(pd.PeriodIndex(et0_short.index, freq="Y")).sum()
    et0_har_Rs=et0_har_Rs.groupby(pd.PeriodIndex(et0_har_Rs.index, freq="Y")).sum()
    et0_liv=et0_liv.groupby(pd.PeriodIndex(et0_liv.index, freq="Y")).sum()
    et0_modif=et0_modif.groupby(pd.PeriodIndex(et0_modif.index, freq="Y")).sum()
    et0_droogersAllen1=et0_droogersAllen1.groupby(pd.PeriodIndex(et0_droogersAllen1.index, freq="Y")).sum()
    et0_droogersAllen2=et0_droogersAllen2.groupby(pd.PeriodIndex(et0_droogersAllen2.index, freq="Y")).sum()
    et0_traj_balk=et0_traj_balk.groupby(pd.PeriodIndex(et0_traj_balk.index, freq="Y")).sum()
    et0_traj_pol=et0_traj_pol.groupby(pd.PeriodIndex(et0_traj_pol.index, freq="Y")).sum()
    et0_modif_droog=et0_modif_droog.groupby(pd.PeriodIndex(et0_modif_droog.index, freq="Y")).sum()
    
    et0=np.array(et0.iloc[:,0])
    et0_short=np.array(et0_short.iloc[:,0])
    et0_har_Rs=np.array(et0_har_Rs.iloc[:,0])
    et0_liv=np.array(et0_liv.iloc[:,0])
    et0_modif=np.array(et0_modif.iloc[:,0])
    et0_droogersAllen1=np.array(et0_droogersAllen1.iloc[:,0])
    et0_droogersAllen2=np.array(et0_droogersAllen2.iloc[:,0])
    et0_traj_balk=np.array(et0_traj_balk.iloc[:,0])
    et0_traj_pol=np.array(et0_traj_pol.iloc[:,0])
    et0_modif_droog=np.array(et0_modif_droog.iloc[:,0])
    ...
    var_1=statistics.variance(et0)
    var_2=statistics.variance(et0_short)
    var_3=statistics.variance(et0_har_Rs)
    var_4=statistics.variance(et0_liv)
    var_5=statistics.variance(et0_modif)
    var_55=statistics.variance(et0_modif_droog)
    var_6=statistics.variance(et0_droogersAllen1)
    var_7=statistics.variance(et0_droogersAllen2)
    var_8=statistics.variance(et0_traj_balk)
    var_9=statistics.variance(et0_traj_pol)
...
results_s.to_csv("C://Users//Viera//Desktop//projekty-clanky//clanok hargreaves//hargreaves with altitude//statistics_of_HG_modiffications_datasets_yearly.csv")
