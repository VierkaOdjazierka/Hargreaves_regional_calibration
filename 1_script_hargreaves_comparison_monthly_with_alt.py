...
for stat in stations:
    ...
    datasets.to_csv('C://Users//Viera//Desktop//projekty-clanky//clanok hargreaves//vysledky_stanice_monthly//et0_rozne_metody'+str(stat)+'.csv')
    ...
    et0=et0.groupby(pd.PeriodIndex(et0.index, freq="M")).sum()
    et0_short=et0_short.groupby(pd.PeriodIndex(et0_short.index, freq="M")).sum()
    et0_har_Rs=et0_har_Rs.groupby(pd.PeriodIndex(et0_har_Rs.index, freq="M")).sum()
    et0_liv=et0_liv.groupby(pd.PeriodIndex(et0_liv.index, freq="M")).sum()
    et0_modif=et0_modif.groupby(pd.PeriodIndex(et0_modif.index, freq="M")).sum()
    et0_droogersAllen1=et0_droogersAllen1.groupby(pd.PeriodIndex(et0_droogersAllen1.index, freq="M")).sum()
    et0_droogersAllen2=et0_droogersAllen2.groupby(pd.PeriodIndex(et0_droogersAllen2.index, freq="M")).sum()
    et0_traj_balk=et0_traj_balk.groupby(pd.PeriodIndex(et0_traj_balk.index, freq="M")).sum()
    et0_traj_pol=et0_traj_pol.groupby(pd.PeriodIndex(et0_traj_pol.index, freq="M")).sum()
    et0_modif_droog=et0_modif_droog.groupby(pd.PeriodIndex(et0_modif_droog.index, freq="M")).sum()
...
results_c.to_csv("C://Users//Viera//Desktop//projekty-clanky//clanok hargreaves//hargreaves with altitude//comparison_of_HG_modiffications_monthly.csv")
...
results_s.to_csv("C://Users//Viera//Desktop//projekty-clanky//clanok hargreaves//hargreaves with altitude//statistics_of_HG_modiffications_datasets_monthly.csv")
